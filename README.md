...
6. **Remote or Non-Remote** - Based on the analysis of both remote and non-remote Data Analyst jobs, I prefer pursuing remote Data Analyst roles. Aside from the competitive average salary these jobs offer, the required skills are more familiar to me compared to non-remote roles. SQL, a popular and essential skill for Data Analyst positions, is an optimal choice for remote work, making it a priority for me to learn and master. Although the overall average salary is higher for non-remote roles due to the more advanced skill requirements, I prefer focusing on remote Data Analyst jobs for the comfort and experience advantages, especially as a fresh graduate.


# Learnings
This project provided me with valuable insights into using SQL for Data Analysis. The findings can serve as a guide for future job seekers looking to develop relevant skills and find the most suitable job titles. Since this project focuses solely on Data Analyst roles, it offers a clearer view of in-demand skills, high-paying competencies, and job posting trends across different months. This overall analysis highlights the importance of continuous growth in the field of Data Analysis and the need to adapt to industry changes.

Through the SQL course by Luke Barousse and Kelly Adams, I gained hands-on experience in using SQL for Data Analysis. This project allowed me to apply SQL techniques to extract insights from multiple tables and connect them to a database. More importantly, it helped me develop the ability to create a data-driven narrative, reinforcing the importance of storytelling in analysis.
